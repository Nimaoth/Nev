...
when implModule:
  ...
  proc forceUpdateCompletions(provider: CompletionProviderLsp) =
  ...
  proc newCompletionProviderLsp*(document: Document, languageServer: LanguageServer): CompletionProvider =
    ...
    self.forceUpdateCompletionsImpl = proc(self: CompletionProvider) = self.CompletionProviderLsp.forceUpdateCompletions()
    self
