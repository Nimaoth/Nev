...
method init*(self: PluginApi, services: Services, engine: ptr WasmEngineT) =
  ...
  self.host.platform = services.getServiceChecked(PlatformService).platform
  self.host.commands = services.getServiceChecked(CommandService)
  self.host.commandLine = services.getServiceChecked(CommandLineService)
  self.host.registers = services.getServiceChecked(Registers)
  self.host.editors = services.getServiceChecked(DocumentEditorService)
  self.host.layout = services.getServiceChecked(LayoutService)
  self.host.plugins = services.getServiceChecked(PluginService)
  self.host.settings = services.getServiceChecked(ConfigService).runtime
  self.host.vfsService = services.getServiceChecked(VFSService)
  self.host.events = services.getServiceChecked(EventService)
  self.host.sessions = services.getServiceChecked(SessionService)
  self.host.vfs = self.host.vfsService.vfs
  self.host.moves = services.getServiceChecked(MoveDatabase)
