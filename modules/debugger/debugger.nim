#use hover_component layout text_editor_component treesitter_component command_service decoration_component event_service session language_server_component selector_popup
import platform/[tui]
...
when implModule:
  ...
  import dap_client, config_provider, selector_popup/builder, events, dynamic_view, document, document_editor, layout/layout, platform_service, session
