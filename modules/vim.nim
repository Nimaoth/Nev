#use command_component snippet_component search_component layout text_editor_component register command_service decoration_component input_handler move_component
