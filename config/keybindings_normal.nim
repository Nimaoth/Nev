...
proc loadVSCodeKeybindings*() {.expose("load-vscode-keybindings").} =
  ...
  addCommand "editor", "<C-g>e", "explore-root"
  addCommand "editor", "<C-g>v", "explore-files", "", showVFS=true
  addCommand "editor", "<C-g>w", "explore-workspace"
  addCommand "editor", "<C-g>W", "explore-files", "ws0://".normalizePath
  addCommand "editor", "<C-g>u", "explore-user-config"
  addCommand "editor", "<C-g>a", "explore-app-config"
