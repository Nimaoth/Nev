...
let constDeclClass* = newNodeClass(IdConstDecl, "ConstDecl", alias="const", base=expressionClass,
  properties=[PropertyDescription(id: IdConstDeclName, role: "name", typ: PropertyType.String)],
  children=[
...
let letDeclClass* = newNodeClass(IdLetDecl, "LetDecl", alias="let", base=expressionClass,
  properties=[PropertyDescription(id: IdLetDeclName, role: "name", typ: PropertyType.String)],
  children=[
...
let varDeclClass* = newNodeClass(IdVarDecl, "VarDecl", alias="var", base=expressionClass,
  properties=[PropertyDescription(id: IdVarDeclName, role: "name", typ: PropertyType.String)],
  children=[
...
let parameterDeclClass* = newNodeClass(IdParameterDecl, "ParameterDecl", alias="parameter", base=expressionClass,
  properties=[PropertyDescription(id: IdParameterDeclName, role: "name", typ: PropertyType.String)],
  children=[
...
builder.addBuilderFor stringLiteralClass.id, idNone(), proc(builder: CellBuilder, node: AstNode): Cell =
  var cell = CollectionCell(node: node)
...
builder.addBuilderFor constDeclClass.id, idNone(), proc(builder: CellBuilder, node: AstNode): Cell =
  ...
  cell.fillChildren = proc() =
    ...
    cell.children.add PropertyCell(node: node, property: IdConstDeclName)
    cell.children.add ConstantCell(node: node, text: " : ")
...
builder.addBuilderFor letDeclClass.id, idNone(), proc(builder: CellBuilder, node: AstNode): Cell =
  ...
  cell.fillChildren = proc() =
    ...
    cell.children.add PropertyCell(node: node, property: IdLetDeclName)
    cell.children.add ConstantCell(node: node, text: " : ")
...
builder.addBuilderFor varDeclClass.id, idNone(), proc(builder: CellBuilder, node: AstNode): Cell =
  ...
  cell.fillChildren = proc() =
    ...
    cell.children.add PropertyCell(node: node, property: IdVarDeclName)
    cell.children.add ConstantCell(node: node, text: " : ")
...
builder.addBuilderFor parameterDeclClass.id, idNone(), proc(builder: CellBuilder, node: AstNode): Cell =
  ...
  cell.fillChildren = proc() =
    ...
    cell.children.add PropertyCell(node: node, property: IdParameterDeclName)
    cell.children.add ConstantCell(node: node, text: " : ")
...
builder.addBuilderFor nodeReferenceClass.id, idNone(), proc(builder: CellBuilder, node: AstNode): Cell =
  var cell = NodeReferenceCell(node: node, reference: IdNodeReferenceTarget)
  return cell
