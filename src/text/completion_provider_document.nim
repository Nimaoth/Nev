...
when implModule:
  ...
  proc forceUpdateCompletions(provider: CompletionProviderDocument) =
  ...
  proc newCompletionProviderDocument*(document: Document): CompletionProvider =
    ...
    self.forceUpdateCompletionsImpl = proc(self: CompletionProvider) = self.CompletionProviderDocument.forceUpdateCompletions()
