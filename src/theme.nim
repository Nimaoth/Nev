...
type
  ...
  ThemeService* = ref object of DynamicService
    theme*: Theme
...
proc themeTokenColorc(theme: Theme, name: cstring, default: Color = Color(r: 0, g: 0, b: 0, a: 1)): Color
proc themeTokenColor2(theme: Theme, names: openArray[string], default: Color = Color(r: 0, g: 0, b: 0, a: 1)): Color
proc themeAnyColor(theme: Theme, names: seq[string], default: Color = Color(r: 0, g: 0, b: 0, a: 1)): Color
proc themeTokenBackgroundColor(theme: Theme, name: string, default: Color = Color(r: 0, g: 0, b: 0, a: 1)): Color
proc themeTokenFontStyle(theme: Theme, name: string): set[FontStyle]
proc themeTokenFontStylec(theme: Theme, name: cstring): set[FontStyle]
...
proc color*(theme: Theme, names: seq[string], default: Color = Color(r: 0, g: 0, b: 0, a: 1)): Color = themeColor2(theme, names, default)
proc tokenColor*(theme: Theme, name: string, default: Color = Color(r: 0, g: 0, b: 0, a: 1)): Color = themeTokenColor(theme, name, default)
proc tokenColor*(theme: Theme, name: cstring, default: Color = Color(r: 0, g: 0, b: 0, a: 1)): Color = themeTokenColorc(theme, name, default)
proc tokenColor*(theme: Theme, names: openArray[string], default: Color = Color(r: 0, g: 0, b: 0, a: 1)): Color = themeTokenColor2(theme, names, default)
proc anyColor*(theme: Theme, names: seq[string], default: Color = Color(r: 0, g: 0, b: 0, a: 1)): Color = themeAnyColor(theme, names, default)
proc tokenBackgroundColor*(theme: Theme, name: string, default: Color = Color(r: 0, g: 0, b: 0, a: 1)): Color = themeTokenBackgroundColor(theme, name, default)
proc tokenFontStyle*(theme: Theme, name: string): set[FontStyle] = themeTokenFontStyle(theme, name)
proc tokenFontStyle*(theme: Theme, name: cstring): set[FontStyle] = themeTokenFontStylec(theme, name)
