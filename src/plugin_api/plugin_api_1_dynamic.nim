...
proc coreFinishBackground*(instance: ptr InstanceData, args: LispVal, namedArgs: LispVal): LispVal =
  ...
  return newNil()
proc coreSleepAsync*(instance: ptr InstanceData, args: LispVal, namedArgs: LispVal): LispVal =
  instance.coreSleepAsync(getArg(args, namedArgs, 0, "task", uint64), getArg(args, namedArgs, 1, "milliseconds", uint32), )
  return newNil()
...
proc registersReplayCommands*(instance: ptr InstanceData, args: LispVal, namedArgs: LispVal): LispVal =
  ...
  return newNil()
proc eventsListenEvent*(instance: ptr InstanceData, args: LispVal, namedArgs: LispVal): LispVal =
  instance.eventsListenEvent(getArg(args, namedArgs, 0, "fun", uint32), getArg(args, namedArgs, 1, "data", uint32), getArg(args, namedArgs, 2, "id", string), getArg(args, namedArgs, 3, "pattern", string), )
  return newNil()
proc eventsStopListenEvent*(instance: ptr InstanceData, args: LispVal, namedArgs: LispVal): LispVal =
  instance.eventsStopListenEvent(getArg(args, namedArgs, 0, "id", string), getArg(args, namedArgs, 1, "pattern", string), )
  return newNil()
proc eventsEmitEvent*(instance: ptr InstanceData, args: LispVal, namedArgs: LispVal): LispVal =
  instance.eventsEmitEvent(getArg(args, namedArgs, 0, "event", string), getArg(args, namedArgs, 1, "payload", string), )
  return newNil()
proc sessionGetSessionData*(instance: ptr InstanceData, args: LispVal, namedArgs: LispVal): LispVal =
  let res = instance.sessionGetSessionData(getArg(args, namedArgs, 0, "name", string), )
  return res.toJson().jsonTo(LispVal)
proc sessionSetSessionData*(instance: ptr InstanceData, args: LispVal, namedArgs: LispVal): LispVal =
  instance.sessionSetSessionData(getArg(args, namedArgs, 0, "name", string), getArg(args, namedArgs, 1, "value", string), )
  return newNil()
proc dispatchDynamic*(instance: ptr InstanceData, name: string, args: LispVal, namedArgs: LispVal): LispVal =
  ...
  of "core.sleep-async": coreSleepAsync(instance, args, namedArgs)
  ...
  of "text-editor.all-text-editors": textEditorAllTextEditors(instance, args, namedArgs)
  ...
  of "text-editor.start-transaction": textEditorStartTransaction(instance, args, namedArgs)
  of "text-editor.end-transaction": textEditorEndTransaction(instance, args, namedArgs)
  ...
  of "text-editor.add-overlay": textEditorAddOverlay(instance, args, namedArgs)
  of "text-editor.clear-overlays": textEditorClearOverlays(instance, args, namedArgs)
  of "text-editor.allocate-overlay-id": textEditorAllocateOverlayId(instance, args, namedArgs)
  of "text-editor.release-overlay-id": textEditorReleaseOverlayId(instance, args, namedArgs)
  of "text-editor.add-custom-render-callback": textEditorAddCustomRenderCallback(instance, args, namedArgs)
  of "text-editor.remove-custom-render-callback": textEditorRemoveCustomRenderCallback(instance, args, namedArgs)
  ...
  of "text-document.path": textDocumentPath(instance, args, namedArgs)
  of "render.create-texture": renderCreateTexture(instance, args, namedArgs)
  of "render.update-texture": renderUpdateTexture(instance, args, namedArgs)
  of "render.delete-texture": renderDeleteTexture(instance, args, namedArgs)
  ...
  of "events.listen-event": eventsListenEvent(instance, args, namedArgs)
  of "events.stop-listen-event": eventsStopListenEvent(instance, args, namedArgs)
  of "events.emit-event": eventsEmitEvent(instance, args, namedArgs)
  of "session.get-session-data": sessionGetSessionData(instance, args, namedArgs)
  of "session.set-session-data": sessionSetSessionData(instance, args, namedArgs)
