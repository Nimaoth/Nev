...
proc fromJsonHook*[K: string|cstring, V](t: var (Table[K, V] | OrderedTable[K, V]), jsonNode: JsonNode, opt = Joptions()) =
...
proc fromJsonHook*(a: var StringTableRef, b: JsonNode, opt = Joptions()) =
