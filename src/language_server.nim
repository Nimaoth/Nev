...
variant(CompletionItemTextEditVariant, LspTextEdit, InsertReplaceEdit)
...
type
  CompletionItem* = object
    ...
    additionalTextEdits*: seq[LspTextEdit]
...
type
  ...
  CodeAction* = object
    ...
    diagnostics*: Option[seq[LspDiagnostic]]
...
type InlayHintResponse* = Option[seq[LspInlayHint]]
...
type
  ...
  LanguageServer* = ref object of RootObj
    ...
    getCompletionsImpl*: proc(self: LanguageServer, filename: string, location: Cursor): Future[Response[CompletionList]] {.gcsafe, raises: [].}
    ...
    resolveWorkspaceSymbolImpl*: proc(self: LanguageServer, symbol: WorkspaceSymbol): Future[Option[Definition]] {.gcsafe, raises: [].}
    getHoverImpl*: proc(self: LanguageServer, filename: string, location: Cursor): Future[Option[string]] {.gcsafe, raises: [].}
    getSignatureHelpImpl*: proc(self: LanguageServer, filename: string, location: Cursor): Future[Response[seq[SignatureHelpResponse]]] {.gcsafe, raises: [].}
    ...
    getDiagnosticsImpl*: proc(self: LanguageServer, filename: string): Future[Response[seq[LspDiagnostic]]] {.gcsafe, raises: [].}
    getCompletionTriggerCharsImpl*: proc(self: LanguageServer): set[char] {.gcsafe, raises: [].}
    getCodeActionsImpl*: proc(self: LanguageServer, filename: string, selection: Selection, diagnostics: seq[LspDiagnostic]): Future[Response[CodeActionResponse]] {.gcsafe, raises: [].}
    renameImpl*: proc(self: LanguageServer, filename: string, position: Cursor, newName: string): Future[Response[seq[WorkspaceEdit]]] {.gcsafe, raises: [].}
...
proc toLspPosition*(cursor: Cursor): Position = Position(line: cursor.line, character: cursor.column)
proc toLspRange*(selection: Selection): Range = Range(start: selection.first.toLspPosition, `end`: selection.last.toLspPosition)
...
proc getCompletions*(self: LanguageServer, filename: string, location: Cursor): Future[Response[CompletionList]] {.gcsafe, raises: [].} =
  if self.getCompletionsImpl != nil:
    return self.getCompletionsImpl(self, filename, location)
  else:
    return Response[CompletionList].default.toFuture
...
proc resolveWorkspaceSymbol*(self: LanguageServer, symbol: WorkspaceSymbol): Future[Option[Definition]] {.gcsafe, raises: [].} =
...
proc getSignatureHelp*(self: LanguageServer, filename: string, location: Cursor): Future[Response[seq[SignatureHelpResponse]]] {.gcsafe, raises: [].} =
  if self.getSignatureHelpImpl != nil:
    return self.getSignatureHelpImpl(self, filename, location)
  else:
    return Response[seq[SignatureHelpResponse]].default.toFuture
...
proc getDiagnostics*(self: LanguageServer, filename: string): Future[Response[seq[LspDiagnostic]]] {.gcsafe, raises: [].} =
  if self.getDiagnosticsImpl != nil:
    return self.getDiagnosticsImpl(self, filename)
  else:
    return Response[seq[LspDiagnostic]].default.toFuture
...
proc getCodeActions*(self: LanguageServer, filename: string, selection: Selection, diagnostics: seq[LspDiagnostic]): Future[Response[CodeActionResponse]] {.gcsafe, raises: [].} =
  if self.getCodeActionsImpl != nil:
    return self.getCodeActionsImpl(self, filename, selection, diagnostics)
  else:
    return Response[CodeActionResponse].default.toFuture

proc rename*(self: LanguageServer, filename: string, position: Cursor, newName: string): Future[Response[seq[WorkspaceEdit]]] {.gcsafe, raises: [].} =
  if self.renameImpl != nil:
    return self.renameImpl(self, filename, position, newName)
  else:
    return Response[seq[WorkspaceEdit]].default.toFuture
