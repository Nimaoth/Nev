...
proc editor_text_getNextDiagnostic_Selection_TextDocumentEditor_Cursor_int_int_bool_bool_impl(
    self: TextDocumentEditor; cursor: Cursor; severity: int = 0;
    offset: int = 0; includeAfter: bool = true; wrap: bool = true): Selection  {.importc.}
proc editor_text_closeDiff_void_TextDocumentEditor_impl(self: TextDocumentEditor)  {.importc.}
...
proc popup_selector_getSelectedItem_JsonNode_SelectorPopup_impl(
    self: SelectorPopup): JsonNode  {.importc.}
...
proc editor_closeView_void_App_int_bool_impl(index: int; keepHidden: bool = true)  {.importc.}
...
proc editor_closeEditor_void_App_string_impl(path: string)  {.importc.}
...
proc editor_scriptIsSelectorPopup_bool_EditorId_impl(editorId: EditorId): bool  {.importc.}
...
proc editor_collectGarbage_void_App_impl()  {.importc.}
proc editor_printStatistics_void_App_impl()  {.importc.}
