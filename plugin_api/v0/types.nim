...
proc typesWriteStringImported(a0: int32; a1: int64; a2: int32; a3: int32): void {.
    wasmimport("[method]shared-buffer.write-string", "nev:plugins/types").}
proc writeString*(self: SharedBuffer; index: int64; data: WitString): void {.
    nodestroy.} =
  var
    arg0: int32
    arg1: int64
  ...
  typesWriteStringImported(arg0, arg1, arg2, arg3)
