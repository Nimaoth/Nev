...
proc isReplayingCommands*(): bool {.nodestroy.} =
  ## Returns true if commands are currently being replayed from a register.
...
proc isRecordingCommands*(register: WitString): bool {.nodestroy.} =
  ## Returns true if commands are currently being recorded to the given register.
  var
    arg0: int32
    arg1: int32
  if register.len > 0:
...
proc setRegisterText*(text: WitString; register: WitString): void {.nodestroy.} =
  ## Sets the text content of the specified register.
  var
    arg0: int32
    arg1: int32
    arg2: int32
...
proc getRegisterText*(register: WitString): WitString {.nodestroy.} =
  ## Gets the text content of the specified register.
  var
...
proc startRecordingCommands*(register: WitString): void {.nodestroy.} =
  ## Starts recording commands to the specified register.
  var
    arg0: int32
    arg1: int32
  if register.len > 0:
...
proc stopRecordingCommands*(register: WitString): void {.nodestroy.} =
  ## Stops recording commands to the specified register.
  var
    arg0: int32
    arg1: int32
  if register.len > 0:
...
proc replayCommands*(register: WitString): void {.nodestroy.} =
  ## Replays the commands stored in the specified register.
  var
    arg0: int32
    arg1: int32
  if register.len > 0:
