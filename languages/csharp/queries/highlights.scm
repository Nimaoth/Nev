;; Methods
(method_declaration name: (identifier) @variable.function)
(local_function_statement name: (identifier) @variable.function)

;; Types
(interface_declaration name: (identifier) @storage.type)
(class_declaration name: (identifier) @storage.type)
(enum_declaration name: (identifier) @storage.type)
(struct_declaration (identifier) @storage.type)
(record_declaration (identifier) @storage.type)
(record_struct_declaration (identifier) @storage.type)
...
(_ type: (identifier) @storage.type)
...
;; Class
(base_list (identifier) @storage.type) ;; applies to record_base too
...
;; Type
(generic_name (identifier) @storage.type)
(type_parameter (identifier) @property.definition)
(type_argument_list (identifier) @storage.type)
(as_expression right: (identifier) @storage.type)
(is_expression right: (identifier) @storage.type)
...
;; Method calls
(invocation_expression (member_access_expression name: (identifier) @variable.function))